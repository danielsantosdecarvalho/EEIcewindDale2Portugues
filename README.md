...
| Full plate | Armadura de Batalha |
...
| Shield, light steel | Escudo Pequeno de Metal |
| Shield, heavy wooden | Escudo Grande de Madeira |
| Shield, heavy steel | Escudo Grande de Metal |
| Shield, tower | Escudo de Corpo |
...
| Gauntlet, locked | Manopla de Segurança |
...
## ? Magias de 4º Nível — Feiticeiro/Mago

| Escola | Inglês                               | Português                                   |
|--------|--------------------------------------|---------------------------------------------|
| Abjuração | Dimensional Anchor               | Âncora Dimensional                          |
| Abjuração | Fire Trap                        | Armadilha de Fogo                           |
| Abjuração | Globe of Invulnerability, Lesser | Globo de Invulnerabilidade Menor            |
| Abjuração | Remove Curse                     | Remover Maldição                            |
| Abjuração | Stoneskin                        | Pele Rochosa                                |
| Conjuração | Dimension Door                  | Porta Dimensional                           |
| Conjuração | Evard’s Black Tentacles         | Tentáculos Negros de Evard                  |
| Conjuração | Leomund’s Secure Shelter        | Refúgio Seguro de Leomund                   |
| Conjuração | Minor Creation                  | Criar Itens Efêmeros                        |
| Conjuração | Solid Fog                       | Névoa Sólida                                |
| Conjuração | Summon Monster IV               | Invocar Criaturas IV                       |
| Conjuração | Spider Spawn                    | Invocar Aranha                              |
| Conjuração | Carrion Summons                | Invocar Verme de Carniça                   |
| Conjuração | Vitriolic Sphere               | Esfera Vitriólica                           |
| Adivinhação | Arcane Eye                    | Olho Arcano                                 |
| Adivinhação | Detect Scrying                | Detectar Vidência                           |
| Adivinhação | Locate Creature               | Localizar Criatura                          |
| Adivinhação | Scrying                       | Vidência                                    |
| Encantamento | Charm Monster               | Enfeitiçar Monstro                          |
| Encantamento | Confusion                   | Confusão                                    |
| Encantamento | Crushing Despair             | Desespero Esmagador                         |
| Encantamento | Geas, Lesser                 | Missão Menor                                |
| Encantamento | Emotion: Fear               | Emoção: Medo                                |
| Encantamento | Emotion: Hope               | Emoção: Esperança                           |
| Encantamento | Malison                     | Maldição                                    |
| Encantamento | Emotion: Despair            | Emoção: Desespero                           |
| Evocação | Fire Shield                      | Escudo do Fogo                              |
| Evocação | Ice Storm                        | Tempestade Glacial                          |
| Evocação | Otiluke’s Resilient Sphere      | Esfera Resiliente de Otiluke                |
| Evocação | Shout                            | Grito                                       |
| Evocação | Wall of Fire                    | Muralha de Fogo                             |
| Evocação | Wall of Ice                     | Muralha de Gelo                             |
| Ilusão | Hallucinatory Terrain             | Terreno Ilusório                            |
| Ilusão | Illusory Wall                    | Parede Ilusória                             |
| Ilusão | Invisibility, Greater            | Invisibilidade Maior                        |
| Ilusão | Phantasmal Killer                | Assassino Fantasmagórico                    |
| Ilusão | Rainbow Pattern                  | Padrão Prismático                           |
| Ilusão | Shadow Conjuration               | Conjuração de Sombras                       |
| Necromancia | Animate Dead                | Criar Mortos-Vivos Menor                   |
| Necromancia | Bestow Curse                | Rogar Maldição                              |
| Necromancia | Contagion                  | Praga                                       |
| Necromancia | Enervation                 | Drenar Temporário                           |
...
| Necromancia | Ghoulish Feast             | Banquete do Carniçal                       |
| Transmutação | Enlarge Person, Mass      | Aumentar Pessoa em Massa                   |
| Transmutação | Polymorph                 | Metamorfose                                |
| Transmutação | Rary’s Mnemonic Enhancer  | Melhoria Mnemônica de Rary                 |
| Transmutação | Reduce Person, Mass       | Reduzir Pessoa em Massa                    |
| Transmutação | Stone Shape               | Moldar Rochas                              |
| Transmutação | Suffocate                 | Sufocar                                     |
| Transmutação | Teleport Field            | Campo de Teleporte                         |
| Transmutação | Polymorph Self            | Metamorfose Pessoal                        |
| Universal | Chaos Cast                     | Conjuração do Caos                          |

---

## ? Magias de 5º Nível — Feiticeiro/Mago

| Escola | Inglês                              | Português                                  |
|--------|-------------------------------------|--------------------------------------------|
| Abjuração | Break Enchantment              | Cancelar Encantamento                      |
| Abjuração | Dismissal                      | Expulsão                                   |
| Abjuração | Mordenkainen’s Private Sanctum | Santuário Particular de Mordenkainen       |
| Conjuração | Cloudkill                     | Névoa Mortal                               |
| Conjuração | Leomund’s Secret Chest        | Arca Secreta de Leomund                    |
| Conjuração | Major Creation                | Criar Itens Temporários                   |
| Conjuração | Mordenkainen’s Faithful Hound | Cão Fiel de Mordenkainen                   |
| Conjuração | Planar Binding, Lesser        | Âncora Planar Menor                       |
| Conjuração | Summon Monster V              | Invocar Criaturas V                       |
| Conjuração | Teleport                      | Teletransporte                             |
| Conjuração | Wall of Stone                 | Muralha de Pedra                          |
| Adivinhação | Contact Other Plane          | Contato Extra-planar                      |
| Adivinhação | Prying Eyes                  | Olhos Observadores                        |
| Adivinhação | Rary’s Telepathic Bond       | Ligação Telepática de Rary                |
...
| Encantamento | Mind Fog                   | Névoa Mental                              |
| Encantamento | Symbol of Sleep             | Símbolo do Sono                           |
| Evocação | Bigby’s Interposing Hand       | Mão Interposta de Bigby                   |
| Evocação | Cone of Cold                   | Cone Glacial                              |
| Evocação | Sending                        | Enviar Mensagem                           |
| Evocação | Wall of Force                  | Muralha de Energia / Muralha de Força     |
| Evocação | Shroud of Flame                | Manto de Chamas                           |
| Evocação | Phantom Blade                  | Lâmina Fantasma                           |
| Evocação | Ball Lightning                 | Bola de Raios                             |
| Ilusão | Dream                            | Sonho                                     |
| Ilusão | False Vision                     | Visão Falsa                               |
| Ilusão | Mirage Arcana                   | Miragem Arcana                            |
| Ilusão | Nightmare                       | Pesadelo                                  |
| Ilusão | Persistent Image                | Imagem Persistente                        |
| Ilusão | Seeming                         | Similaridade                              |
| Ilusão | Shadow Evocation                | Evocação de Sombras                       |
| Necromancia | Blight                     | Malogro                                   |
| Necromancia | Magic Jar                  | Recipiente Arcano                         |
| Necromancia | Symbol of Pain              | Símbolo da Dor                            |
...
| Transmutação | Animal Growth             | Ampliar Animais                           |
| Transmutação | Baleful Polymorph          | Metamorfose Tórrida                      |
| Transmutação | Fabricate                 | Compor                                    |
| Transmutação | Overland Flight            | Vôo Prolongado                            |
| Transmutação | Passwall                  | Criar Passagens                           |
| Transmutação | Telekinesis               | Telecinésia                               |
| Transmutação | Transmute Mud to Rock      | Lama em Pedra                             |
| Transmutação | Transmute Rock to Mud      | Pedra em Lama                             |
| Transmutação | Lower Resistance           | Reduzir Resistência                      |
| Transmutação | Lutzaen's Local Teleport   | Teleporte Local de Lutzaen                |
| Transmutação | Steal Spells               | Roubo de Feitiços                         |
| Transmutação | Ghostform                 | Forma Fantasmagórica                     |
| Transmutação | Rewind Time               | Retroceder / Reverter o Tempo             |
| Universal | Permanency                    | Permanência                               |

---

## ? Magias de 6º Nível — Feiticeiro/Mago

| Escola | Inglês | Português |
|------|--------|-----------|
| Abjuração | Antimagic Field | Campo Antimagia |
| Abjuração | Dispel Magic, Greater | Dissipar Magia Maior |
| Abjuração | Globe of Invulnerability | Globo de Invulnerabilidade |
| Abjuração | Guards and Wards | Proteger Fortalezas |
| Abjuração | Repulsion | Repulsão |
| Abjuração | Protection from Magic Energy | Proteção contra Energia Mágica |
| Conjuração | Acid Fog | Névoa Ácida |
| Conjuração | Planar Binding | Âncora Planar |
| Conjuração | Summon Monster VI | Invocar Criaturas VI |
| Conjuração | Wall of Iron | Muralha de Ferro |
| Conjuração | Wyvern Call | Chamado do Wyvern |
| Conjuração | Boulder Roll | Rocha Rolante |
| Adivinhação | Analyze Dweomer | Analisar Encantamento |
| Adivinhação | Legend Lore | Lendas e Histórias |
| Adivinhação | True Seeing | Visão da Verdade |
| Adivinhação | Power Word Silence | Palavra de Poder, Silêncio |
| Encantamento | Geas/Quest | Tarefa / Missão |
| Encantamento | Heroism, Greater | Heroísmo Maior |
| Encantamento | Suggestion, Mass | Sugestão em Massa |
| Encantamento | Symbol of Persuasion | Símbolo da Persuasão |
| Encantamento | Domination | Dominação |
| Encantamento | Chaos | Caos |
| Evocação | Bigby’s Forceful Hand | Mão Vigorosa de Bigby |
| Evocação | Chain Lightning | Corrente de Relâmpagos |
| Evocação | Contingency | Contingência |
| Evocação | Otiluke’s Freezing Sphere | Esfera Gélida de Otiluke |
| Evocação | Isaac's Greater Missile Storm | Tempestade Maior de Mísseis de Isaac |
| Ilusão | Mislead | Despistar |
| Ilusão | Permanent Image | Imagem Permanente |
| Ilusão | Programmed Image | Imagem Programada |
| Ilusão | Shadow Walk | Andar nas Sombras |
| Ilusão | Veil | Véu |
| Necromancia | Circle of Death | Círculo da Morte |
| Necromancia | Create Undead | Criar Mortos-Vivos |
| Necromancia | Eyebite | Ataque Visual |
| Necromancia | Symbol of Fear | Símbolo do Medo |
...
| Transmutação | Bear’s Endurance, Mass | Vigor do Urso em Massa |
| Transmutação | Bull’s Strength, Mass | Força do Touro em Massa |
| Transmutação | Cat’s Grace, Mass | Agilidade do Gato em Massa |
| Transmutação | Control Water | Controlar Água |
| Transmutação | Disintegrate | Desintegrar |
| Transmutação | Eagle’s Splendor, Mass | Esplendor da Águia em Massa |
| Transmutação | Flesh to Stone | Carne para Pedra |
| Transmutação | Fox’s Cunning, Mass | Astúcia da Raposa em Massa |
| Transmutação | Mordenkainen’s Lucubration | Elucubração de Mordenkainen |
| Transmutação | Move Earth | Mover Terra |
| Transmutação | Owl’s Wisdom, Mass | Sabedoria da Coruja em Massa |
| Transmutação | Stone to Flesh | Pedra em Carne |
| Transmutação | Tenser’s Transformation | Transformação de Tenser |
| Transmutação | Death Fog | Névoa da Morte |
| Transmutação | Freeze Inanimates | Congelar Inanimados |

---

## ? Magias de 7º Nível — Feiticeiro/Mago

| Escola | Inglês | Português |
|------|--------|-----------|
| Abjuração | Banishment | Banimento |
| Abjuração | Sequester | Refugiar Itens |
| Abjuração | Spell Turning | Reverter Magia |
| Abjuração | Seven Eyes | Sete Olhos |
| Abjuração | Mantle | Manto |
| Abjuração | Steal Effects | Roubo de Efeitos |
| Conjuração | Drawmij’s Instant Summons | Convocação Instantânea de Drawmij |
| Conjuração | Mordenkainen’s Magnificent Mansion | Mansão Magnífica de Mordenkainen |
| Conjuração | Phase Door | Passagem Invisível |
| Conjuração | Plane Shift | Viagem Planar |
| Conjuração | Summon Monster VII | Invocar Criaturas VII |
| Conjuração | Teleport, Greater | Teletransporte Maior |
| Conjuração | Teleport Object | Teletransportar Objeto |
| Conjuração | Vipergout | Cospe Víbora |
| Conjuração | Cacofiend | Cacodemônio |
| Conjuração | Stygian Ice Storm | Tempestade Glacial Estígia |
| Adivinhação | Arcane Sight, Greater | Visão Arcana Maior |
| Adivinhação | Scrying, Greater | Vidência Maior |
| Adivinhação | Vision | Visão |
| Adivinhação | Power Word: Stun | Palavra de Poder: Atordoar |
...
| Encantamento | Symbol of Stunning | Símbolo do Atordoamento |
| Evocação | Bigby’s Grasping Hand | Mão Poderosa de Bigby |
| Evocação | Delayed Blast Fireball | Bola de Fogo Controlável / Bola de Fogo com Explosão Retardada |
| Evocação | Forcecage | Cubo de Energia |
| Evocação | Mordenkainen’s Sword | Espada de Mordenkainen |
| Evocação | Prismatic Spray | Rajada Prismática |
| Evocação | Malavon's Rage | Fúria de Malavon |
| Evocação | Acid Storm | Tempestade Ácida |
| Evocação | Lightning Barrage | Barragem de Raios |
| Ilusão | Invisibility, Mass | Invisibilidade em Massa |
| Ilusão | Project Image | Projetar Imagem |
| Ilusão | Shadow Conjuration, Greater | Conjuração de Sombras Maior |
| Ilusão | Simulacrum | Simulacro |
| Necromancia | Control Undead | Controlar Mortos-Vivos |
| Necromancia | Finger of Death | Dedo da Morte |
| Necromancia | Symbol of Weakness | Símbolo da Fraqueza |
| Necromancia | Waves of Exhaustion | Ondas da Exaustão |
| Necromancia | Reanimate | Reanimar |
| Necromancia | Skeleton Traps | Armadilhas de Esqueleto |
| Transmutação | Control Weather | Controlar o Clima |
| Transmutação | Ethereal Jaunt | Passeio Etéreo |
| Transmutação | Reverse Gravity | Inverter a Gravidade |
| Transmutação | Statue | Estátua |
| Transmutação | Skip Time | Pular no Tempo |
| Transmutação | Omnipresence | Onipresença |
| Universal | Limited Wish | Desejo Restrito |
| Universal | Spell Sequencer | Sequenciador de Feitiços |

---

## ? Magias de 8º Nível — Feiticeiro/Mago

| Escola | Inglês | Português |
|------|--------|-----------|
| Abjuração | Dimensional Lock | Tranca Dimensional |
| Abjuração | Mind Blank | Limpar a Mente / Mente Vazia |
| Abjuração | Prismatic Wall | Muralha Prismática |
| Abjuração | Protection from Spells | Proteção Contra Magias |
| Abjuração | Elemental Barrier | Barreira Elemental |
| Abjuração | Spell Trap | Armadilha de Feitiços |
| Conjuração | Incendiary Cloud | Nuvem Incendiária |
| Conjuração | Maze | Labirinto |
| Conjuração | Planar Binding, Greater | Âncora Planar Maior |
| Conjuração | Summon Monster VIII | Invocar Criaturas VIII |
| Conjuração | Trap the Soul | Aprisionar a Alma |
| Conjuração | Fiery Cloud | Nuvem Flamejante |
| Conjuração | Summon Fiend | Invocar Demônio |
| Adivinhação | Discern Location | Discernir Localização |
| Adivinhação | Moment of Prescience | Instante de Presciência / Momento de Presciência |
| Adivinhação | Prying Eyes, Greater | Olhos Observadores Maior |
| Encantamento | Antipathy | Antipatia |
| Encantamento | Binding | Prisão |
| Encantamento | Charm Monster, Mass | Enfeitiçar Monstro em Massa |
| Encantamento | Demand | Ordem |
| Encantamento | Otto’s Irresistible Dance | Dança Irresistível de Otto |
| Encantamento | Power Word Stun | Palavra de Poder, Atordoar |
| Encantamento | Symbol of Insanity | Símbolo da Insanidade |
| Encantamento | Sympathy | Simpatia |
| Encantamento | Enslave | Escravizar |
| Encantamento | Link Effects | Efeitos Vinculados |
| Encantamento | Otto's Irresistible Spin | Giro Irresistível de Otto |
| Evocação | Bigby’s Clenched Fist | Punho Cerrado de Bigby |
| Evocação | Otiluke’s Telekinetic Sphere | Esfera Telecinética de Otiluke |
| Evocação | Polar Ray | Raio Polar |
| Evocação | Shout, Greater | Grito Maior |
| Evocação | Sunburst | Explosão Solar |
| Evocação | Metafireball | Meta Bola de Fogo |
| Evocação | Living Lightning | Relâmpago Vivo |
| Ilusão | Scintillating Pattern | Padrão Cintilante |
| Ilusão | Screen | Animação Ilusória |
| Ilusão | Shadow Evocation, Greater | Evocação de Sombras Maior |
| Necromancia | Clone | Clone |
| Necromancia | Create Greater Undead | Criar Mortos-Vivos Maior |
| Necromancia | Horrid Wilting | Evaporação |
| Necromancia | Symbol of Death | Símbolo da Morte |
| Necromancia | Contagious Fear | Medo Contagiante |
| Transmutação | Iron Body | Corpo de Ferro |
| Transmutação | Polymorph Any Object | Metamorfosear Objetos |
| Transmutação | Temporal Stasis | Estase Temporal |
| Transmutação | Symbol of Hopelessness | Símbolo do Desespero |
| Transmutação | Teleport Step | Passo Teleporte |
| Transmutação | True Polymorph | Metamorfose Verdadeira |

---

## ? Magias de 9º Nível — Feiticeiro/Mago

| Escola | Inglês | Português |
|------|--------|-----------|
| Abjuração | Freedom | Libertação |
| Abjuração | Imprisonment | Aprisionamento |
| Abjuração | Mordenkainen’s Disjunction | Disjunção de Mordenkainen |
| Abjuração | Prismatic Sphere | Esfera Prismática |
| Abjuração | Aegis | Égide |
| Conjuração | Gate | Portal |
| Conjuração | Refuge | Refúgio |
| Conjuração | Summon Monster IX | Invocar Criaturas IX |
| Conjuração | Teleportation Circle | Círculo de Teletransporte |
| Conjuração | Black Blade of Disaster | Lâmina Negra do Desastre |
| Conjuração | Malavon's Corrosive Fog | Névoa Corrosiva de Malavon |
| Adivinhação | Foresight | Sexto Sentido |
| Adivinhação | Mass Omnivision | Omnivisão em Massa |
...
| Evocação | Bigby’s Crushing Hand | Mão Esmagadora de Bigby |
| Evocação | Meteor Swarm | Chuva de Meteoros |
| Evocação | Lightning Spiral | Espiral de Relâmpago |
| Ilusão | Shades | Sombras |
| Ilusão | Weird | Encarnação Fantasmagórica |
| Ilusão | Perfect Invisibility | Invisibilidade Perfeita |
| Necromancia | Astral Projection | Projeção Astral |
...
| Transmutação | Etherealness | Forma Etérea |
| Transmutação | Shapechange | Alterar Forma |
| Transmutação | Time Stop | Parar o Tempo |
| Transmutação | Improved Haste | Velocidade Aprimorada |
| Universal | Wish | Desejo |
| Universal | Improved Alacrity | Alacridade Aprimorada |
| Universal | Eclectic Sequencer | Sequenciador Eclético |

---

## ? Magias de 0º Nível — Clérigo (Orisons)
...
| Guidance | Orientação |
| Inflict Minor Wounds | Infligir Ferimentos Mínimos |
| Light | Luz |
| Mending | Consertar |
...
| Obscuring Mist | Névoa Obscurescente |
| Protection from Chaos/Evil/Good/Law | Proteção Contra o Caos/Mal/Bem/Ordem |
| Remove Fear | Remover Medo |
| Sanctuary | Santuário |
| Shield of Faith | Escudo da Fé |
| Summon Monster I | Invocar Criaturas I |
| Armor of Faith | Armadura da Fé |
| Shortening | Redução |

---

## ? Magias de 2º Nível — Clérigo

| Inglês | Português |
|--------|-----------|
| Aid | Ajuda |
| Align Weapon | Tendência em Arma |
| Augury | Augúrio |
| Bear’s Endurance | Vigor do Urso |
...
| Resist Energy | Resistência à Elementos |
| Restoration, Lesser | Restauração Menor |
| Shatter | Despedaçar |
...
| Undetectable Alignment | Dissimular Tendência |
| Zone of Truth | Zona da Verdade |
| Chant | Cântico |
| Spell Shield | Escudo Mágico |
| Slow Poison | Desacelerar Veneno |
| Draw Upon Holy Might | Utilizar Poder Sagrado |
| Null Healing | Cura Nula |
| Simple Summoning | Invocação Simples |

---

## ? Magias de 3º Nível — Clérigo
...
| Daylight | Luz do Dia |
| Deeper Darkness | Escuridão Profunda |
| Dispel Magic | Dissipar Magia |
| Glyph of Warding | Símbolo de Proteção |
| Helping Hand | Mão Opífera |
| Inflict Serious Wounds | Infligir Ferimentos Graves |
| Invisibility Purge | Purgar Invisibilidade |
| Locate Object | Localizar Objetos |
| Magic Circle against Chaos/Evil/Good/Law | Círculo Mágico Contra o Caos/Mal/Bem/Ordem |
...
| Remove Disease | Remover Doenças |
...
| Circle of Bones | Círculo de Ossos |
...
| Dimensional Anchor | Âncora Dimensional |
...
| Imbue with Spell Ability | Transferência de Poder Divino / Imbuir com Habilidade Mágica |
| Inflict Critical Wounds | Infligir Ferimentos Críticos |
| Magic Weapon, Greater | Arma Mágica Maior |
...
| Spell Immunity | Imunidade à Magia |
| Summon Monster IV | Invocar Criaturas IV |
| Tongues | Idiomas |
| Defensive Harmony | Harmonia Defensiva |
| Shield of Lathander | Escudo de Lathander |
| Unholy Blight | Pestilência Profana |
| Holy Power | Poder Sagrado |
| Mental Domination | Dominação Mental |
| Cloak of Fear | Capa do Medo |
| Cloud of Pestilence | Nuvem de Pestilência |
| Curing Contingency | Contingência de Cura |
| Ghoulish Feast | Banquete do Carniçal |
| Holy Smite | Golpe Sagrado (*sem descrição*) |

---

## ? Magias de 5º Nível — Clérigo

| Inglês | Português |
|--------|-----------|
| Atonement | Penitência |
...
| Mark of Justice | Marca da Justiça |
| Plane Shift | Viagem Planar |
| Raise Dead | Reviver os Mortos |
| Righteous Might | Força dos Justos |
| Scrying | Vidência |
| Slay Living | Matar |
| Spell Resistance | Resistência à Magia |
| Summon Monster V | Invocar Criaturas V |
| Symbol of Pain | Símbolo da Dor |
| Symbol of Sleep | Símbolo do Sono |
| True Seeing | Visão da Verdade |
| Unhallow | Conspurcar |
| Wall of Stone | Muralha de Pedra |
| Champion's Strength | Força do Campeão |
| Righteous Wrath of the Faithful | Ira Justa dos Fiéis |
| Healing Circle | Círculo de Cura |
| Iron Skins | Pele de Ferro |
| Chaotic Commands | Comandos Caóticos |
| Lesser Planar Binding | Vinculação Planar Menor |
| Pebbles to Boulders | Pedras em Rochas |
| Ghostform | Forma Fantasmagórica |

---

## ? Magias de 6º Nível — Clérigo
...
| Bear’s Endurance, Mass | Vigor do Urso em Massa |
| Blade Barrier | Barreira de Lâminas |
| Bull’s Strength, Mass | Força do Touro em Massa |
...
| Eagle’s Splendor, Mass | Esplendor da Águia em Massa |
| Find the Path | Encontrar o Caminho |
| Forbiddance | Proibição |
| Geas/Quest | Tarefa/Missão |
| Glyph of Warding, Greater | Símbolo de Proteção Maior |
| Harm | Doença Plena |
| Heal | Cura Completa |
| Heroes’ Feast | Banquete de Heróis |
| Inflict Moderate Wounds, Mass | Ferimentos Moderados em Massa |
| Owl’s Wisdom, Mass | Sabedoria da Coruja em Massa |
| Planar Ally | Aliado Extra-Planar |
| Summon Monster VI | Invocar Criaturas VI |
| Symbol of Fear | Símbolo do Medo |
| Symbol of Persuasion | Símbolo da Persuasão |
| Undeath to Death | Destruir Mortos-Vivos |
| Wind Walk | Caminhar no Vento |
| Word of Recall | Palavra de Recordação |
| Circle of Blades | Círculo de Lâminas |
| Spiritual Wrath | Ira Espiritual |
| Sol's Searing Orb | Orbe Ardente de Sol |
| Dolorous Decay | Decadência Dolorosa |
| Planar Binding | Vinculação Planar |
| Wondrous Recall | Palavra de Recordação |
| Bolt of Glory | Raio da Glória |
| Trial by Fire | Provação pelo Fogo |
| Second Chance | Segunda Chance |

---

## ? Magias de 7º Nível — Clérigo
...
| Dictum | Ditado |
| Ethereal Jaunt | Passeio Etéreo |
| Holy Word | Palavra Sagrada |
| Inflict Serious Wounds, Mass | Infligir Ferimentos Graves em Massa |
| Refuge | Refúgio |
| Regenerate | Regeneração |
| Repulsion | Repulsão |
| Restoration, Greater | Restauração Maior |
| Resurrection | Ressurreição |
| Scrying, Greater | Vidência Maior |
| Summon Monster VII | Invocar Criaturas VII |
| Symbol of Stunning | Símbolo do Atordoamento |
| Symbol of Weakness | Símbolo da Fraqueza |
| Word of Chaos | Palavra do Caos |
| Impervious Sanctity of Mind | Santidade Impermeável da Mente |
...
| Cure Critical Wounds, Mass | Curar Ferimentos Críticos em Massa |
| Dimensional Lock | Tranca Dimensional |
| Discern Location | Discernir Localização |
| Earthquake | Terremoto |
| Fire Storm | Tempestade de Fogo |
| Holy Aura | Aura Sagrada |
| Inflict Critical Wounds, Mass | Infligir Ferimentos Críticos em Massa |
| Planar Ally, Greater | Aliado Extra-Planar Maior |
| Shield of Law | Escudo da Ordem |
| Spell Immunity, Greater | Imunidade à Magia Maior |
| Summon Monster VIII | Invocar Criaturas VIII |
| Symbol of Death | Símbolo da Morte |
| Symbol of Insanity | Símbolo da Insanidade |
| Unholy Aura | Aura Profana |
| Symbol of Hopelessness | Símbolo do Desespero |
...
| Mass Harm | Doença Plena em Massa |
| Contingent Resurrection | Ressurreição Condicional |
...
| Magic Fang, Greater | Presa Mágica Maior |
| Meld into Stone | Mesclar-se às Rochas |
| Neutralize Poison | Neutralizar Venenos |
...
| Stone Shape | Moldar Rochas |
| Summon Nature’s Ally III | Invocar Aliado da Natureza III |
| Water Breathing | Respirar na Água |
| Wind Wall | Muralha de Vento |
| Tortoise Shell | Carapaça de Tartaruga |
| Mold Touch | Toque de Mofo |
| Moonblade | Lâmina da Lua |
| Icelance | Lança de Gelo |
...
|-------|-----------|
| Air Walk | Andar no Ar |
| Antiplant Shell | Cúpula de Proteção Contra Vegetais |
| Blight | Malogro |
...
| Summon Nature’s Ally IV | Invocar Aliado da Natureza IV |
...
| Atonement | Penitência |
| Awaken | Despertar |
| Baleful Polymorph | Metamorfose Tórrida |
| Call Lightning Storm | Convocar Tempestade de Relâmpagos |
...
| Summon Nature’s Ally V | Invocar Aliado da Natureza V |
...
| Bear’s Endurance, Mass | Vigor do Urso em Massa |
| Bull’s Strength, Mass | Força do Touro em Massa |
| Cat’s Grace, Mass | Agilidade do Gato em Massa |
| Cure Light Wounds, Mass | Curar Ferimentos Leves em Massa |
| Dispel Magic, Greater | Dissipar Magia Maior |
| Find the Path | Encontrar o Caminho |
| Fire Seeds | Semente de Fogo |
| Ironwood | Madeira-Ferro |
| Liveoak | Carvalho Vivo |
| Move Earth | Mover Terra |
| Owl’s Wisdom, Mass | Sabedoria da Coruja em Massa |
| Repel Wood | Repelir Madeira |
| Spellstaff | Bordão de Magia |
| Stone Tell | Conto das Rochas |
| Summon Nature’s Ally VI | Invocar Aliado da Natureza VI |
...
| Heal | Cura Completa |
| Scrying, Greater | Vidência Maior |
| Summon Nature’s Ally VII | Invocar Aliado da Natureza VII |
| Sunbeam | Raio de Sol |
| Transmute Metal to Wood | Metal em Madeira |
| True Seeing | Visão da Verdade |
| Wind Walk | Caminhar no Vento |
| Mist of Eldath | Névoa de Eldath |
| Aura of Vitality | Aura de Vitalidade |
| Vipergout | Cospe Víbora |
| Elemental Barrier | Barreira Elemental |
...
| Summon Nature’s Ally VIII | Invocar Aliado da Natureza VIII |
...
| Storm of Vengeance | Tempestade da Vingança |
| Summon Nature’s Ally IX | Invocar Aliado da Natureza IX |
| Sympathy | Simpatia |
| Improved Alacrity | Alacridade Aprimorada |
| Elemental Legion | Legião Elemental |
| Auril's Blessing | Bênção de Auril |
...
| Lesser Confusion | Confusão Menor |
| Glibness | Loquacidade |
| Sculpt Sound | Esculpir Som |
| Zone of Silence | Zona de Silêncio |
| Copy Spell | Feitiço Copiado |
| Song of Discord | Canção da Discórdia |
| Sympathetic Vibration | Vibração Sônica |
| Songcasting | Canto Mágico |
| Void Sound | Som do Vazio |
| Fortune's Favorite | Favorito da Sorte |
| Army of Images | Exército de Imagens |
...
| Unholy Weapon | Arma Profana |
| Explosive Smite | Destruir o Mal Explosivo |
